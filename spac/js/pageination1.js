...
// 	'            <div @click="pageUp(0)" class="pagination_page" :class="startDisabled?\'disabled\':\'\'">首页</div>\n' +
	...
	'        </div>\n' +
		'            <div @click="pageUp(1)" class="pagination_prev pagination_page" :class="startDisabled?\'disabled\':\'\'">←&nbsp上一页</div>\n' +
...
Vue.component('pageination', {
	...
	mounted:function(){
		this.h=document.getElementsByClassName("product-banner2")[0].offsetHeight;
	},
	watch: {
